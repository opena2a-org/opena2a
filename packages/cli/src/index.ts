...
Learn more: https://opena2a.org/docs`);
  ...
  program
    ...
    .description('Agent identity management (list|create|trust|audit|log|policy|check|sign|verify|attach|detach|sync|connect|disconnect|tag|mcp|activity|suspend|reactivate)')
