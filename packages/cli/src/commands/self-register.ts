...
export const TOOL_MANIFEST: ToolManifest[] = [
  ...
  {
    name: 'hma-researcher',
    displayName: 'HMA Researcher',
    description: 'Autonomous security researcher - bug bounty hunting with LLM-powered analysis',
    packageType: 'ai_tool',
    version: '0.1.0',
    repositoryUrl: 'https://github.com/opena2a-org/hma-researcher',
    license: 'Apache-2.0',
    tags: ['research', 'bounty', 'autonomous'],
    scannable: true,
    npmPackage: 'hma-researcher',
  },
  {
    name: 'hma-hunter',
    displayName: 'HMA Hunter',
    description: 'Autonomous vulnerability hunter - multi-turn attack decomposition',
    packageType: 'ai_tool',
    version: '0.1.0',
    repositoryUrl: 'https://github.com/opena2a-org/hma-hunter',
    license: 'Apache-2.0',
    tags: ['hunter', 'attack', 'autonomous'],
    scannable: true,
    npmPackage: 'hma-hunter',
  },
  {
    name: 'opena2a-arp',
